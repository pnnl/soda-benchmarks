...
config.soda_libs_dir = os.path.join(config.soda_obj_root, "lib")

config.substitutions.append(("%soda_libs", config.soda_libs_dir))
...
llvm_config.with_environment(
    "PYTHONPATH",
    [
        os.path.join(config.mlir_obj_dir, "python_packages", "soda"),
    ],
    append_path=True,
)
