...
// RUN:   --pass-pipeline="builtin.module(soda-instr-hw-counter-at-loop-bounds)" |\
// RUN:   FileCheck %s 

module {
  // CHECK: func.func private @sodaInstrHWCounter(i1, index)
    ...
    scf.for %arg3 = %c0 to %c8 step %c1 {
      ...
      scf.for %arg4 = %c0 to %c8 step %c1 {
        ...
        scf.for %arg5 = %c0 to %c16 step %c1 {
          ...
          // CHECK: func.call @sodaInstrHWCounter(%[[STOP5]], %[[LOC5]]) : (i1, index) -> ()
        }
        // CHECK: func.call @sodaInstrHWCounter(%[[STOP4]], %[[LOC4]]) : (i1, index) -> ()
      }
      // CHECK: func.call @sodaInstrHWCounter(%[[STOP3]], %[[LOC3]]) : (i1, index) -> ()
    }
