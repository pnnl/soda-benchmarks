...
`make` will generate the Verilog design and run the testbench.


## How to extend?

The IP integration requires multiple files to be present. Once the files are in place, the `Makefile` must be updated to include the new files in the build process. 
